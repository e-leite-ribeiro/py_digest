...
```bash
> python3 app.py <amount> <base_currency_code> <target_currencies_list> |-r <optional_email>|
```
...
- `-r <optional_email>` - user can send email to another address, if left empty it will send to his own
